...
class Controller:
        ...
        if (self.flagMessage == True):
            ...
            for n in range(1, len(self.number_neuros_per_layer)):
                if (n == 1):
                    ...
                    print("###################")
                    print([self.number_neuros_per_layer[n - 1] + 1, self.number_neuros_per_layer[n]])
                    print(weightsPart[n - 1])
                    print(len(weightsPart[n - 1]))
    ...
    def calculate_fitness(self):
        ...
        spinningFitness = 1 - (abs(self.velocity_left - self.velocity_right) ** 0.5)
